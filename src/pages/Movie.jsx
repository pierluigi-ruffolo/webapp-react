          ...
          <div className="col-lg-4">
            <div className="bg-dark p-4 rounded-4 border border-secondary shadow h-100">
              ...
              <ul className="list-unstyled">
                <li className="mb-3">
                  <span className="text-secondary d-block small">TITOLO</span>
                  <span className="text-white fw-bold">{movie.title}</span>
                </li>
                <li className="mb-3">
                  <span className="text-secondary d-block small">REGISTA</span>
                  <span className="text-white fw-bold">{movie.director}</span>
                </li>
                <li className="mb-3">
                  <span className="text-secondary d-block small">GENERE</span>
